...
def _create_opponents(num_envs: int, phase: PhaseConfig, state_dim: int, action_dim: int) -> List:
...
def _switch_phase(
    ...
    opponents = _create_opponents(num_envs, new_phase, state_dim, action_dim)
